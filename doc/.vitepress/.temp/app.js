...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"Ursa Components","description":"Ursa Vue 3 通用组件库文档","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"指南","link":"/guide/getting-started"},{"text":"组件","link":"/components/overview"}],"sidebar":[{"text":"开始","items":[{"text":"快速开始","link":"/guide/getting-started"}]},{"text":"组件","items":[{"text":"Overview 组件总览","link":"/components/overview"},{"text":"Basic 基础组件","collapsed":false,"items":[{"text":"Button 按钮","link":"/components/basic/button"},{"text":"Border 边框","link":"/components/basic/border"},{"text":"Color 色彩","link":"/components/basic/color"},{"text":"Container 布局容器","link":"/components/basic/container"},{"text":"Icon 图标","link":"/components/basic/icon"},{"text":"Layout 布局","link":"/components/basic/layout"},{"text":"Link 链接","link":"/components/basic/link"},{"text":"Text 文本","link":"/components/basic/text"},{"text":"Scrollbar 滚动条","link":"/components/basic/scrollbar"},{"text":"Space 间距","link":"/components/basic/space"},{"text":"Splitter 分隔面板","link":"/components/basic/splitter"}]}]}],"socialLinks":[]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
