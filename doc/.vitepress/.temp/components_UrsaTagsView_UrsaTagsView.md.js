...
import { O as Oe, S as SourceCodeViewer } from "./SourceCodeViewer.BOCOoOQx.js";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "tags-demo-wrap" }, _attrs))} data-v-0f38ad0e>`);
      _push(ssrRenderComponent(unref(Oe), {
        "home-path": "/dashboard",
        "home-title": "首页"
      }, null, _parent));
      _push(`</div>`);
...
const BaseUrsaTagsView = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-0f38ad0e"]]);
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  __ssrInlineRender: true,
  setup(__props) {
    const loadBaseUrsaTagsViewSource = async () => (await import("./BaseUrsaTagsView.DDQc4_1F.js")).default;
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(BaseUrsaTagsView, null, null, _parent));
